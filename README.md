...
I am a Mobile Application Developer and B.Tech Computer Science graduate with a strong foundation in both Data Analytics and Mobile App Development.

🔭 Current Status:
Contributing to my team as Mobile Appliation Developer @ Bytexus, building cross-platfrom applications using React Native.

🛠️ Technical Skills:
App Dev: React Native, Firebase, Redux, Xcode, ContextApi, Java , JavaScript.
